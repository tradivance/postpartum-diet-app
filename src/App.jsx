...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Scroll listener for future animations
      window.scrollY > 20;
    };
  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-300 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          <div className="flex-shrink-0 flex items-center">
            <a href="#" className="font-en font-bold text-2xl tracking-tighter text-black hover:opacity-70 transition-opacity">
  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1584863289773-b49588422771?q=80&w=2574&auto=format&fit=crop"
          alt="産後ピラティス"
    ...
    <section id="plan" className="py-20 md:py-32" style={{ backgroundColor: colors.gray }}>
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {plans.map((plan, idx) => (
            <Reveal key={idx} delay={idx * 100}>
              <div className={`bg-white p-10 shadow-sm ${plan.popular ? 'border-2 shadow-lg relative' : 'border border-gray-200'}`} style={plan.popular ? { borderColor: colors.pink } : {}}>
                {plan.popular && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 pb-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <a href="#" className="font-en font-bold text-3xl tracking-tighter mb-6 block">
              W2 <span style={{ color: colors.pink }}>PILATES</span>
            </a>
